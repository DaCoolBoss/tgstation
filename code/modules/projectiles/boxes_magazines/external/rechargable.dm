...
/obj/item/ammo_box/magazine/recharge/s220
	name = "plasma pack"
...
/obj/item/ammo_box/magazine/recharge/s220/Destroy()
	explosion(src, heavy_impact_range = 1, light_impact_range = rand(2,4), flame_range = rand(3,4), flash_range = rand(1,3), adminlog = TRUE)
	return ..()
