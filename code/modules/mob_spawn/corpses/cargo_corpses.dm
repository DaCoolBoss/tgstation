...
/obj/effect/mob_spawn/corpse/human/medical_cadaver/proc/select_outfit()
	var/burial_outfit = pick_weight(list(
		"tuxedo"
	))
...
/obj/effect/mob_spawn/corpse/human/medical_cadaver/proc/select_outfit()
	var/funeral_outfit = pick_weight(list(
		/datum/outfit/spacefuneral = 60,
		/datum/outfit/weddingdress = 5,
		/datum/outfit/tuxedo = 10,
		/datum/outfit/corpsescrubs = 25,
	))
	return funeral_outfit

/datum/outfit/spacefuneral
	name = "Funeral Clothes"
