...
/obj/item/clothing/suit/jacket/det_suit/cyberpunk
	name = "armored jacket"
	icon_state = "noirdet"
	desc = "A faux-leather trenchcoat with concealed kevlar plating. Offers good protection without catching too much attention."
